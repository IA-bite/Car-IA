...
<head>
  ...
  <title>CL Muktimarcas Luxury — Carros e Motos de Luxo</title>
  <meta name="description" content="CL Muktimarcas Luxury — Vendas de carros e motos de luxo. Estoque selecionado, atendimento premium e condições exclusivas." />
  <meta name="keywords" content="carros de luxo, motos de luxo, multimarcas, supercarros, superbikes, concessionária, venda de carros" />
  <meta property="og:title" content="CL Muktimarcas Luxury" />
  <meta property="og:description" content="Vendas de carros e motos de luxo com atendimento premium." />
  ...
  <style>
    :root{
      --bg: #0b0b0c;          /* preto profundo */
      --panel:#111114;        /* painéis */
      --text:#f7f7f7;         /* texto principal */
      --muted:#bcbcbc;        /* texto suave */
      --gold:#d1b35e;         /* dourado elegante */
      --gold-2:#b8993e;       /* dourado escuro */
    ...
    *{box-sizing:border-box}
    ...
    body{
      font-family:'Outfit',system-ui,-apple-system,Segoe UI,Robotto,Helvetica,Arial,sans-serif;
      background: radial-gradient(80vw 80vh at 60% -10%, rgba(209,179,94,.18), transparent 60%), var(--bg);
      color:var(--text);
      line-height:1.6;
    }
    ...
    .nav{
      ...
      background: linear-gradient(0deg, rgba(11,11,12,.7), rgba(11,11,12,.7));
    ...
    .brand h1{font-size:1.05rem;margin:0;font-weight:700;letter-spacing:.5px}
    .brand span{display:block;font-size:.72rem;color:var(--muted);margin-top:-4px}
...
<body>
    ...
    <div class="container contact">
      ...
      <div>
        <div class="panel" style="height:100%">
          ...
          <div class="hero-media" style="aspect-ratio:16/9;margin-top:10px;background-image:url('https://images.unsplash.com/photo-1502877338535-766e1452684a?q=80&w=1600&auto=format&fit=crop');">
  ...
  <script type="application/ld+json">
  {
    ...
    "name": "CL Muktimarcas Luxury",
    "url": "https://www.clmuktimarcasluxury.com.br/",
    "description": "Vendas de carros e motos de luxo com atendimento premium.",
    "address": {
      "@type": "PostalAddress",
      "streetAddress": "Av. das Nações, 1000",
      "addressLocality": "Goiânia",
      "addressRegion": "GO",
      "postalCode": "74000-000",
      "addressCountry": "BR"
    },
    "telephone": "+55 62 99117-3072",
